# Exercise 0.5: SAP (Single Page App Diagram)
...
sequenceDiagram
    ...
    activate server
    server-->>browser: [{ "content": "SPA is the way", "date": "2026-04-05" }, ... ]
    deactivate server

    Note right of browser: The browser renders the notes using the JavaScript callback
```
